...
class VictoriaMetricInfoProvider implements MetricInfoProvider<VictoriaMetricInfo> {
    @VisibleForTesting
    ...
    public VictoriaMetricInfoProvider() {}

    @Override
    public VictoriaMetricInfo getMetricInfo(String metricName, MetricGroup group) {
        return new VictoriaMetricInfo(getScopedName(metricName, group), getTags(group));
    }
